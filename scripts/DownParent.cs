...
public class DownParent : MonoBehaviour
{
    [SerializeField] GameObject parent;

    public void OnClick()
    {
        if (ItemBox.instance.CheckSelectItem(Item.Type.CopperKey))
        {
            MessagePanel.instance.ShowPanel("Œ®‚ªŠJ‚¢‚½");
            ItemBox.instance.UseSelectItem();
            UseKey();
        }
        else if (ItemBox.instance.CheckSelectItem(Item.Type.GoldKey))
        {
